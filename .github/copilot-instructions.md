...
- Use **Conventional Commits**.
    ...
    - **Commit message body lines must be ≤ 100 characters** (enforced by `body-max-line-length`). Do not include long URLs or agent-generated metadata in commit bodies — they will fail CI.
